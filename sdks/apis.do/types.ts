...
/**
 * Dynamic API proxy type that allows property access to be converted to API calls
 * Example: api.research({ topic: 'AI' }) will call https://apis.do/research?topic=AI
 */
export interface ApiProxy {
  research(params: import('./src/types').ResearchParams): Promise<import('./src/types').ResearchResult>
  
  _baseUrl: string
  
  _options: import('./src/types').ClientOptions
  
  // Dynamic property access for other API calls
  [key: string]: any
}
/**
