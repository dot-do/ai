...
describe('Functions Collection E2E Tests', () => {
  ...
  it(
    'should list functions with pagination',
    async () => {
  ...
  it(
    'should create a function and get it by ID',
    async () => {
  ...
  it(
    'should replace a function completely',
    async () => {
