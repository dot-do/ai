...
export const Things: CollectionConfig = {
  ...
  fields: [
    ...
    { name: 'context', type: 'code', admin: { language: 'markdown', editorOptions } },
    { name: 'content', type: 'code', admin: { language: 'markdown', editorOptions } },
    { name: 'data', type: 'json', admin: { editorOptions } },
    { name: 'reasoning', type: 'code', admin: { language: 'markdown', editorOptions } },
    { name: 'citations', type: 'code', admin: { language: 'markdown', editorOptions } },
    {
      name: 'relationships',
      type: 'array',
      fields: [
