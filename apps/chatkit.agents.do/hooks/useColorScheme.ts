...
export function useColorScheme(initialPreference: ColorSchemePreference = 'system'): UseColorSchemeResult {
  ...
  const scheme = useMemo<ColorScheme>(() => (preference === 'system' ? systemScheme : preference), [preference, systemScheme])
