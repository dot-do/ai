import { MousePointerClickIcon, PanelTopDashedIcon, SquareMenuIcon, SquareSlashIcon } from 'lucide-react'

import { Card } from './card'
import { buttonCode, contextMenuCode, modalCode, selectMenuCode, signalCode, slashCommandCode } from './codes'
...
bot, enabling customized and responsive behavior."
        ...
        withMeteors
      >
        <CodeBlock lang="js" code={signalCode} wrapper={{ className: 'flex-grow mt-0' }} />
      </HorizontalSection>
      ...
      >
        <CodeBlock lang="js" code={selectMenuCode} wrapper={{ className: 'flex-grow mt-0' }} />
      </HorizontalSection>
    </>
  )
}
