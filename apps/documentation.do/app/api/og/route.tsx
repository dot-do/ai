...
const bold = fetch(new URL('./Geist-Bold.woff', import.meta.url)).then((res) => res.arrayBuffer())
...
export async function GET(request: NextRequest): Promise<ImageResponse> {
  ...
  return new ImageResponse(
    OG({
      title: title ?? 'Sunar',
      description: description ?? 'The Discord.js Framework',
    }),
    {
      width: 1200,
      height: 630,
    ...
    >
      ...
      <div tw="flex flex-row justify-between items-center mt-auto p-8">
        <div tw="flex flex-row items-center">
          <svg width="48px" height="48px" viewBox="0 0 556 556" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
              fillRule="evenodd"
              clipRule="evenodd"
