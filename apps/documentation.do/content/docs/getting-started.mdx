...
<Callout>
  This basically register all loaded application commands (by default globally). If you want to change this behavior read the [registering commands
  guide](/docs/guides/registering-commands).
</Callout>
...
<Callout>For more information about the interaction handling, see [handle interactions guide](/docs/guides/interactions-handling).</Callout>
