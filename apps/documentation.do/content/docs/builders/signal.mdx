...
<Links>
  <Link label="Source" icon="github" link="https://github.com/sunarjs/sunar/blob/main/packages/sunar/src/builders/signal.ts" />
  <Link label="Signals" icon="discordjs" link="https://discord.js.org/docs/packages/discord.js/main/Events:Enum" />
  <Link label="API Reference" icon="discord" link="https://discord.com/developers/docs/topics/gateway#gateway-events" />
</Links>
