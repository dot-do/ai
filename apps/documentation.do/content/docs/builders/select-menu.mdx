...
<Links>
  <Link label="Source" icon="github" link="https://github.com/sunarjs/sunar/blob/main/packages/sunar/src/builders/selectMenu.ts" />
  <Link label="SelectMenu Interactions" icon="discordjs" link="https://discord.js.org/docs/packages/discord.js/main/AnySelectMenuInteraction:TypeAlias" />
  <Link label="API Reference" icon="discord" link="https://discord.com/developers/docs/interactions/message-components#select-menus" />
</Links>
