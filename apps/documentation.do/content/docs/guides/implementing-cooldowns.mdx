...
<Callout>Cooldowns can be used only for [repliable interactions](https://discord.js.org/docs/packages/discord.js/main/RepliableInteraction:TypeAlias).</Callout>
