 ...
 * Humanloop Client
 *
 * Auto-generated Integration client for Humanloop.
...
import { HumanloopError } from './errors.js'

/**
 * Humanloop client options
 */
export interface HumanloopClientOptions {
...
export class HumanloopClient {
  private options: HumanloopClientOptions
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw HumanloopError.fromError(error)
    }
  }
