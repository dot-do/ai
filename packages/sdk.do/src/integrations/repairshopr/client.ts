 ...
 * Repairshopr Client
 *
 * Auto-generated Integration client for Repairshopr.
...
import { RepairshoprError } from './errors.js'
...
export class RepairshoprClient {
  private options: RepairshoprClientOptions
  ...
  constructor(options: RepairshoprClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw RepairshoprError.fromError(error)
    }
  }
