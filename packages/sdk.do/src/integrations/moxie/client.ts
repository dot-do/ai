 ...
 * Moxie Client
 *
 * Auto-generated Integration client for Moxie.
...
import { MoxieError } from './errors.js'
...
export class MoxieClient {
  private options: MoxieClientOptions
  ...
  constructor(options: MoxieClientOptions) {
    this.options = {
      baseUrl: 'https://api.moxie.com',
      timeout: 30000,
      retryAttempts: 3,
      ...options,
    }
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw MoxieError.fromError(error)
    }
  }
