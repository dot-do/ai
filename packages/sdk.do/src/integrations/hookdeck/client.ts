 ...
 * Hookdeck Client
 *
 * Auto-generated Integration client for Hookdeck.
...
import { HookdeckError } from './errors.js'

/**
 * Hookdeck client options
 */
...
export class HookdeckClient {
  private options: HookdeckClientOptions
  ...
  constructor(options: HookdeckClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw HookdeckError.fromError(error)
    }
  }
