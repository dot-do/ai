 ...
 * Chatbotkit Client
 *
 * Auto-generated Integration client for Chatbotkit.
...
import { ChatbotkitError } from './errors.js'
...
export class ChatbotkitClient {
  private options: ChatbotkitClientOptions
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw ChatbotkitError.fromError(error)
    }
  }
