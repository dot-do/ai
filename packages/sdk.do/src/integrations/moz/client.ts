 ...
 * Moz Client
 *
 * Auto-generated Integration client for Moz.
...
import { MozError } from './errors.js'

/**
 * Moz client options
 */
export interface MozClientOptions {
...
export class MozClient {
  private options: MozClientOptions
  ...
  constructor(options: MozClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw MozError.fromError(error)
    }
  }
