 ...
 * Prerender Client
 *
 * Auto-generated Integration client for Prerender.
...
import { PrerenderError } from './errors.js'

/**
 * Prerender client options
 */
...
export class PrerenderClient {
  private options: PrerenderClientOptions
  ...
  constructor(options: PrerenderClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw PrerenderError.fromError(error)
    }
  }
