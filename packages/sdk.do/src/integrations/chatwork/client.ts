 ...
 * Chatwork Client
 *
 * Auto-generated Integration client for Chatwork.
...
import { ChatworkError } from './errors.js'
...
export class ChatworkClient {
  private options: ChatworkClientOptions
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw ChatworkError.fromError(error)
    }
  }
