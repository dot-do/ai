 ...
 * Superchat Client
 *
 * Auto-generated Integration client for Superchat.
...
import { SuperchatError } from './errors.js'

/**
 * Superchat client options
 */
...
export class SuperchatClient {
  private options: SuperchatClientOptions
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw SuperchatError.fromError(error)
    }
  }
