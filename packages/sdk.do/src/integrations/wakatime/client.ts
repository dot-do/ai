 ...
 * Wakatime Client
 *
 * Auto-generated Integration client for Wakatime.
...
import { WakatimeError } from './errors.js'

/**
 * Wakatime client options
 */
...
export class WakatimeClient {
  private options: WakatimeClientOptions
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw WakatimeError.fromError(error)
    }
  }
