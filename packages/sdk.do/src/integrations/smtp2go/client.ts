 ...
 * Smtp2go Client
 *
 * Auto-generated Integration client for Smtp2go.
...
import { Smtp2goError } from './errors.js'
...
export class Smtp2goClient {
  private options: Smtp2goClientOptions
  ...
  constructor(options: Smtp2goClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw Smtp2goError.fromError(error)
    }
  }
