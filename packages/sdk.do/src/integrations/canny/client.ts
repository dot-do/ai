 ...
 * Canny Client
 *
 * Auto-generated Integration client for Canny.
...
import { CannyError } from './errors.js'

/**
 * Canny client options
 */
export interface CannyClientOptions {
...
export class CannyClient {
  private options: CannyClientOptions
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw CannyError.fromError(error)
    }
  }
