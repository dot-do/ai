 ...
 * Typefully Client
 *
 * Auto-generated Integration client for Typefully.
...
import { TypefullyError } from './errors.js'

/**
 * Typefully client options
 */
...
export class TypefullyClient {
  private options: TypefullyClientOptions
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw TypefullyError.fromError(error)
    }
  }
