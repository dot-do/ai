 ...
 * Listclean Client
 *
 * Auto-generated Integration client for Listclean.
...
import { ListcleanError } from './errors.js'
...
export class ListcleanClient {
  private options: ListcleanClientOptions
  ...
  constructor(options: ListcleanClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw ListcleanError.fromError(error)
    }
  }
