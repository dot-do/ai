 ...
 * Snowflake Client
 *
 * Auto-generated Integration client for Snowflake.
...
export class SnowflakeClient {
  private options: SnowflakeClientOptions
  ...
  constructor(options: SnowflakeClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw SnowflakeError.fromError(error)
    }
  }
