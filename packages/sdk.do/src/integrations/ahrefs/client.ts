 ...
 * Ahrefs Client
 *
 * Auto-generated Integration client for Ahrefs.
...
import { AhrefsError } from './errors.js'

/**
 * Ahrefs client options
 */
...
export class AhrefsClient {
  private options: AhrefsClientOptions
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw AhrefsError.fromError(error)
    }
  }
