 ...
 * Svix Client
 *
 * Auto-generated Integration client for Svix.
...
import { SvixError } from './errors.js'
...
export class SvixClient {
  private options: SvixClientOptions
  ...
  constructor(options: SvixClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw SvixError.fromError(error)
    }
  }
