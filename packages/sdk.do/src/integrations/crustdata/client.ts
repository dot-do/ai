 ...
 * Crustdata Client
 *
 * Auto-generated Integration client for Crustdata.
...
import { CrustdataError } from './errors.js'

/**
 * Crustdata client options
 */
export interface CrustdataClientOptions {
...
export class CrustdataClient {
  private options: CrustdataClientOptions
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw CrustdataError.fromError(error)
    }
  }
