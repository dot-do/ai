 ...
 *
 * Auto-generated Integration client for Launch darkly.
...
import { LaunchDarklyError } from './errors.js'
...
export class LaunchDarklyClient {
  private options: LaunchDarklyClientOptions
  ...
  constructor(options: LaunchDarklyClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw LaunchDarklyError.fromError(error)
    }
  }
