 ...
 * Abyssale Client
 *
 * Auto-generated Integration client for Abyssale.
...
import { AbyssaleError } from './errors.js'
...
export class AbyssaleClient {
  private options: AbyssaleClientOptions
  ...
  constructor(options: AbyssaleClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw AbyssaleError.fromError(error)
    }
  }
