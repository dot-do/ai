 ...
 * Semrush Client
 *
 * Auto-generated Integration client for Semrush.
...
import { SemrushError } from './errors.js'

/**
 * Semrush client options
 */
...
export class SemrushClient {
  private options: SemrushClientOptions
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw SemrushError.fromError(error)
    }
  }
