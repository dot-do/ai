 ...
 * PandaDoc Webhooks
 *
 * Auto-generated webhook handling for PandaDoc Integration.
...
export type WebhookEvent = DocumentStateChangedEvent
...
export class WebhookEventRouter {
  ...
  /**
   * Register handler for document_state_changed events
   * @param handler - Event handler function
   */
  onDocumentStateChanged(handler: (event: DocumentStateChangedEvent) => Promise<void>): void {
    this.on(WEBHOOK_EVENTS.DOCUMENT_STATE_CHANGED, handler as any)
  }
