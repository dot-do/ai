 ...
 * Pandadoc Client
 *
 * Auto-generated Integration client for Pandadoc.
...
import { PandadocError } from './errors.js'

/**
 * Pandadoc client options
 */
export interface PandadocClientOptions {
...
export class PandadocClient {
  private options: PandadocClientOptions
  ...
  constructor(options: PandadocClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw PandadocError.fromError(error)
    }
  }
