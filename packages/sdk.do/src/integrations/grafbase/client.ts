 ...
 * Grafbase Client
 *
 * Auto-generated Integration client for Grafbase.
...
import { GrafbaseError } from './errors.js'
...
export class GrafbaseClient {
  private options: GrafbaseClientOptions
  ...
  constructor(options: GrafbaseClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw GrafbaseError.fromError(error)
    }
  }
