 ...
 * Moneybird Client
 *
 * Auto-generated Integration client for Moneybird.
...
import { MoneybirdError } from './errors.js'

/**
 * Moneybird client options
 */
...
export class MoneybirdClient {
  private options: MoneybirdClientOptions
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw MoneybirdError.fromError(error)
    }
  }
