 ...
 * Zoho books Client
 *
 * Auto-generated Integration client for Zoho books.
...
import { ZohoBooksError } from './errors.js'

/**
 * Zoho books client options
 */
export interface ZohoBooksClientOptions {
  /** OAuth2 access token */
  accessToken: string
  /** Base URL override */
  baseUrl?: string
...
export class ZohoBooksClient {
  private options: ZohoBooksClientOptions
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw ZohoBooksError.fromError(error)
    }
  }
