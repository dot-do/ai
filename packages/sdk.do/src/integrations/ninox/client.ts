 ...
 * Ninox Client
 *
 * Auto-generated Integration client for Ninox.
...
import { NinoxError } from './errors.js'

/**
 * Ninox client options
 */
...
export class NinoxClient {
  private options: NinoxClientOptions
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw NinoxError.fromError(error)
    }
  }
