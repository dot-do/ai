 ...
 * Affinda Client
 *
 * Auto-generated Integration client for Affinda.
...
import { AffindaError } from './errors.js'
 ...
 */
export class AffindaClient {
  private options: AffindaClientOptions
  ...
  constructor(options: AffindaClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw AffindaError.fromError(error)
    }
  }
