 ...
 * Enigma Client
 *
 * Auto-generated Integration client for Enigma.
...
/**
 * Enigma client options
 */
export interface EnigmaClientOptions {
...
export class EnigmaClient {
  private options: EnigmaClientOptions
  ...
  constructor(options: EnigmaClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw EnigmaError.fromError(error)
    }
  }
