 ...
 * Google Admin Client
 *
 * Auto-generated Integration client for Google Admin.
...
import { GoogleAdminError } from './errors.js'
...
export class GoogleAdminClient {
  private options: GoogleAdminClientOptions
  ...
  constructor(options: GoogleAdminClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw GoogleAdminError.fromError(error)
    }
  }
