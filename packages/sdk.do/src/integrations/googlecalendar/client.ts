 ...
 *
 * Auto-generated Integration client for Google Calendar.
...
import { GooglecalendarError } from './errors.js'

/**
 * Google Calendar client options
 */
...
export class GooglecalendarClient {
  private options: GooglecalendarClientOptions
