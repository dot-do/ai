 ...
 * Open sea Client
 *
 * Auto-generated Integration client for Open sea.
...
import { OpenSeaError } from './errors.js'

/**
 * Open sea client options
 */
...
export class OpenSeaClient {
  private options: OpenSeaClientOptions
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw OpenSeaError.fromError(error)
    }
  }
