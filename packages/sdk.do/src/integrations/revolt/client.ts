 ...
 * Revolt Client
 *
 * Auto-generated Integration client for Revolt.
...
import { RevoltError } from './errors.js'

/**
 * Revolt client options
 */
...
export class RevoltClient {
  private options: RevoltClientOptions
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw RevoltError.fromError(error)
    }
  }
