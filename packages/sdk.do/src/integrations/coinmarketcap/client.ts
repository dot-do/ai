 ...
 *
 * Auto-generated Integration client for Coinmarketcap.
...
export class CoinmarketcapClient {
  private options: CoinmarketcapClientOptions
  ...
  constructor(options: CoinmarketcapClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw CoinmarketcapError.fromError(error)
    }
  }
