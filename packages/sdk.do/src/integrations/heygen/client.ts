 ...
 * Heygen Client
 *
 * Auto-generated Integration client for Heygen.
...
import { HeygenError } from './errors.js'

/**
 * Heygen client options
 */
...
export class HeygenClient {
  private options: HeygenClientOptions
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw HeygenError.fromError(error)
    }
  }
