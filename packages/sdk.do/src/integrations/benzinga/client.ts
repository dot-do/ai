 ...
 * Benzinga Client
 *
 * Auto-generated Integration client for Benzinga.
...
import { BenzingaError } from './errors.js'

/**
 * Benzinga client options
 */
...
export class BenzingaClient {
  private options: BenzingaClientOptions
  ...
  constructor(options: BenzingaClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw BenzingaError.fromError(error)
    }
  }
