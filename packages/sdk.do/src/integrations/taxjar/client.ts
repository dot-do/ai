 ...
 * Taxjar Client
 *
 * Auto-generated Integration client for Taxjar.
...
import { TaxjarError } from './errors.js'

/**
 * Taxjar client options
 */
...
export class TaxjarClient {
  private options: TaxjarClientOptions
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw TaxjarError.fromError(error)
    }
  }
