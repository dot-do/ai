 ...
 * Prismic Client
 *
 * Auto-generated Integration client for Prismic.
...
/**
 * Prismic client options
 */
export interface PrismicClientOptions {
...
export class PrismicClient {
  private options: PrismicClientOptions
  ...
  constructor(options: PrismicClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw PrismicError.fromError(error)
    }
  }
