 ...
 * Veriphone Client
 *
 * Auto-generated Integration client for Veriphone.
...
import { VeriphoneError } from './errors.js'
...
export class VeriphoneClient {
  private options: VeriphoneClientOptions
  ...
  constructor(options: VeriphoneClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw VeriphoneError.fromError(error)
    }
  }
