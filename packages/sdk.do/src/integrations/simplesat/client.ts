 ...
 * Simplesat Client
 *
 * Auto-generated Integration client for Simplesat.
...
import { SimplesatError } from './errors.js'
 ...
 */
export class SimplesatClient {
  private options: SimplesatClientOptions
  ...
  constructor(options: SimplesatClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw SimplesatError.fromError(error)
    }
  }
