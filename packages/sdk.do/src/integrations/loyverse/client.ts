 ...
 * Loyverse Client
 *
 * Auto-generated Integration client for Loyverse.
...
import { LoyverseError } from './errors.js'
...
export class LoyverseClient {
  private options: LoyverseClientOptions
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw LoyverseError.fromError(error)
    }
  }
