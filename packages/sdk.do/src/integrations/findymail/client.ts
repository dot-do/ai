 ...
 * Findymail Client
 *
 * Auto-generated Integration client for Findymail.
...
import { FindymailError } from './errors.js'

/**
 * Findymail client options
 */
export interface FindymailClientOptions {
...
export class FindymailClient {
  private options: FindymailClientOptions
  ...
  constructor(options: FindymailClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw FindymailError.fromError(error)
    }
  }
