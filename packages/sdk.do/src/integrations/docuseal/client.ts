 ...
 * Docuseal Client
 *
 * Auto-generated Integration client for Docuseal.
...
import { DocusealError } from './errors.js'

/**
 * Docuseal client options
 */
export interface DocusealClientOptions {
...
export class DocusealClient {
  private options: DocusealClientOptions
  ...
  constructor(options: DocusealClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw DocusealError.fromError(error)
    }
  }
