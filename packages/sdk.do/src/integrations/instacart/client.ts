 ...
 * Instacart Client
 *
 * Auto-generated Integration client for Instacart.
...
import { InstacartError } from './errors.js'

/**
 * Instacart client options
 */
...
export class InstacartClient {
  private options: InstacartClientOptions
  ...
  constructor(options: InstacartClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw InstacartError.fromError(error)
    }
  }
