 ...
 * Langbase Client
 *
 * Auto-generated Integration client for Langbase.
...
import { LangbaseError } from './errors.js'

/**
 * Langbase client options
 */
export interface LangbaseClientOptions {
...
export class LangbaseClient {
  private options: LangbaseClientOptions
  ...
  constructor(options: LangbaseClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw LangbaseError.fromError(error)
    }
  }
