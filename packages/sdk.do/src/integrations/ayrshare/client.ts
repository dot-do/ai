 ...
 * Ayrshare Client
 *
 * Auto-generated Integration client for Ayrshare.
...
import { AyrshareError } from './errors.js'
...
export class AyrshareClient {
  private options: AyrshareClientOptions
  ...
  constructor(options: AyrshareClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw AyrshareError.fromError(error)
    }
  }
