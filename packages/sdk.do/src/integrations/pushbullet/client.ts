 ...
 * Pushbullet Client
 *
 * Auto-generated Integration client for Pushbullet.
...
import { PushbulletError } from './errors.js'
...
export class PushbulletClient {
  private options: PushbulletClientOptions
  ...
  constructor(options: PushbulletClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw PushbulletError.fromError(error)
    }
  }
