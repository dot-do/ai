 ...
 * Seqera Client
 *
 * Auto-generated Integration client for Seqera.
...
import { SeqeraError } from './errors.js'

/**
 * Seqera client options
 */
export interface SeqeraClientOptions {
...
export class SeqeraClient {
  private options: SeqeraClientOptions
  ...
  constructor(options: SeqeraClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw SeqeraError.fromError(error)
    }
  }
