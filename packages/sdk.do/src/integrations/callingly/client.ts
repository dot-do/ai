 ...
 * Callingly Client
 *
 * Auto-generated Integration client for Callingly.
...
import { CallinglyError } from './errors.js'
 ...
 */
export class CallinglyClient {
  private options: CallinglyClientOptions
  ...
  constructor(options: CallinglyClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw CallinglyError.fromError(error)
    }
  }
