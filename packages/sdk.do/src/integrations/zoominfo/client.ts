 ...
 * Zoominfo Client
 *
 * Auto-generated Integration client for Zoominfo.
...
import { ZoominfoError } from './errors.js'

/**
 * Zoominfo client options
 */
...
export class ZoominfoClient {
  private options: ZoominfoClientOptions
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw ZoominfoError.fromError(error)
    }
  }
