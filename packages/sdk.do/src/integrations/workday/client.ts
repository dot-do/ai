 ...
 * Workday Client
 *
 * Auto-generated Integration client for Workday.
...
import { WorkdayError } from './errors.js'

/**
 * Workday client options
 */
...
export class WorkdayClient {
  private options: WorkdayClientOptions
  ...
  constructor(options: WorkdayClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw WorkdayError.fromError(error)
    }
  }
