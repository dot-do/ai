 ...
 * Bitwarden Client
 *
 * Auto-generated Integration client for Bitwarden.
...
import { BitwardenError } from './errors.js'

/**
 * Bitwarden client options
 */
...
export class BitwardenClient {
  private options: BitwardenClientOptions
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw BitwardenError.fromError(error)
    }
  }
