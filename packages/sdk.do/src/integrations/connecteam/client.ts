 ...
 * Connecteam Client
 *
 * Auto-generated Integration client for Connecteam.
...
import { ConnecteamError } from './errors.js'

/**
 * Connecteam client options
 */
...
export class ConnecteamClient {
  private options: ConnecteamClientOptions
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw ConnecteamError.fromError(error)
    }
  }
