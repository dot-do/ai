 ...
 * Bugsnag Client
 *
 * Auto-generated Integration client for Bugsnag.
...
import { BugsnagError } from './errors.js'
...
export class BugsnagClient {
  private options: BugsnagClientOptions
  ...
  constructor(options: BugsnagClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw BugsnagError.fromError(error)
    }
  }
