/**
 * Conversion tools Client
 *
 * Auto-generated Integration client for Conversion tools.
...
import { ConversionToolsError } from './errors.js'
...
export class ConversionToolsClient {
  private options: ConversionToolsClientOptions
  ...
  constructor(options: ConversionToolsClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw ConversionToolsError.fromError(error)
    }
  }
