 ...
 * Kommo Client
 *
 * Auto-generated Integration client for Kommo.
...
import { KommoError } from './errors.js'

/**
 * Kommo client options
 */
...
export class KommoClient {
  private options: KommoClientOptions
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw KommoError.fromError(error)
    }
  }
