 ...
 * Eventbrite Client
 *
 * Auto-generated Integration client for Eventbrite.
...
import { EventbriteError } from './errors.js'

/**
 * Eventbrite client options
 */
...
export class EventbriteClient {
  private options: EventbriteClientOptions
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw EventbriteError.fromError(error)
    }
  }
