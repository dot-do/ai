 ...
 * Finerworks Client
 *
 * Auto-generated Integration client for Finerworks.
...
import { FinerworksError } from './errors.js'
 ...
 */
export class FinerworksClient {
  private options: FinerworksClientOptions
  ...
  constructor(options: FinerworksClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw FinerworksError.fromError(error)
    }
  }
