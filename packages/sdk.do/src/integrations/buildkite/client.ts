 ...
 * Buildkite Client
 *
 * Auto-generated Integration client for Buildkite.
...
export class BuildkiteClient {
  private options: BuildkiteClientOptions
  ...
  constructor(options: BuildkiteClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw BuildkiteError.fromError(error)
    }
  }
