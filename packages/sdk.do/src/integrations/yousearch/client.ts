 ...
 * Yousearch Client
 *
 * Auto-generated Integration client for Yousearch.
...
import { YousearchError } from './errors.js'

/**
 * Yousearch client options
 */
...
export class YousearchClient {
  private options: YousearchClientOptions
  ...
  constructor(options: YousearchClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw YousearchError.fromError(error)
    }
  }
