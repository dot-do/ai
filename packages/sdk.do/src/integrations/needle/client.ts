 ...
 * Needle Client
 *
 * Auto-generated Integration client for Needle.
...
export class NeedleClient {
  private options: NeedleClientOptions
  ...
  constructor(options: NeedleClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw NeedleError.fromError(error)
    }
  }
