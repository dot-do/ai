 ...
 * Brandfetch Client
 *
 * Auto-generated Integration client for Brandfetch.
...
import { BrandfetchError } from './errors.js'

/**
 * Brandfetch client options
 */
export interface BrandfetchClientOptions {
...
export class BrandfetchClient {
  private options: BrandfetchClientOptions
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw BrandfetchError.fromError(error)
    }
  }
