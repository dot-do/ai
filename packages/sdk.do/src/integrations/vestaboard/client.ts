 ...
 * Vestaboard Client
 *
 * Auto-generated Integration client for Vestaboard.
...
import { VestaboardError } from './errors.js'
...
export class VestaboardClient {
  private options: VestaboardClientOptions
  ...
  constructor(options: VestaboardClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw VestaboardError.fromError(error)
    }
  }
