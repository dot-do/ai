 ...
 *
 * Auto-generated Integration client for Google Sheets.
...
import { GooglesheetsError } from './errors.js'

/**
 * Google Sheets client options
 */
...
export class GooglesheetsClient {
  private options: GooglesheetsClientOptions
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw GooglesheetsError.fromError(error)
    }
  }
