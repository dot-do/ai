 ...
 * Listennotes Client
 *
 * Auto-generated Integration client for Listennotes.
...
import { ListennotesError } from './errors.js'
...
export class ListennotesClient {
  private options: ListennotesClientOptions
  ...
  constructor(options: ListennotesClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw ListennotesError.fromError(error)
    }
  }
