 ...
 * Adobe Client
 *
 * Auto-generated Integration client for Adobe.
...
import { AdobeError } from './errors.js'

/**
 * Adobe client options
 */
...
export class AdobeClient {
  private options: AdobeClientOptions
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw AdobeError.fromError(error)
    }
  }
