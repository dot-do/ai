 ...
 * Slackbot Client
 *
 * Auto-generated Integration client for Slackbot.
...
import { SlackbotError } from './errors.js'

/**
 * Slackbot client options
 */
...
export class SlackbotClient {
  private options: SlackbotClientOptions
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw SlackbotError.fromError(error)
    }
  }
