 ...
 * Dripcel Client
 *
 * Auto-generated Integration client for Dripcel.
...
import { DripcelError } from './errors.js'
 ...
 */
export class DripcelClient {
  private options: DripcelClientOptions
  ...
  constructor(options: DripcelClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw DripcelError.fromError(error)
    }
  }
