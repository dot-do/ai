 ...
 * Hashnode Client
 *
 * Auto-generated Integration client for Hashnode.
...
import { HashnodeError } from './errors.js'

/**
 * Hashnode client options
 */
...
export class HashnodeClient {
  private options: HashnodeClientOptions
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw HashnodeError.fromError(error)
    }
  }
