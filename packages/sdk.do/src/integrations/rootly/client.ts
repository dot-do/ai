 ...
 * Rootly Client
 *
 * Auto-generated Integration client for Rootly.
...
import { RootlyError } from './errors.js'

/**
 * Rootly client options
 */
...
export class RootlyClient {
  private options: RootlyClientOptions
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw RootlyError.fromError(error)
    }
  }
