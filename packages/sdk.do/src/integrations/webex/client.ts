 ...
 * Webex Client
 *
 * Auto-generated Integration client for Webex.
...
import { WebexError } from './errors.js'

/**
 * Webex client options
 */
...
export class WebexClient {
  private options: WebexClientOptions
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw WebexError.fromError(error)
    }
  }
