 ...
 * Scrapingant Client
 *
 * Auto-generated Integration client for Scrapingant.
...
import { ScrapingantError } from './errors.js'

/**
 * Scrapingant client options
 */
export interface ScrapingantClientOptions {
...
export class ScrapingantClient {
  private options: ScrapingantClientOptions
  ...
  constructor(options: ScrapingantClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw ScrapingantError.fromError(error)
    }
  }
