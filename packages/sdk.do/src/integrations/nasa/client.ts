 ...
 * Nasa Client
 *
 * Auto-generated Integration client for Nasa.
...
import { NasaError } from './errors.js'
...
export class NasaClient {
  private options: NasaClientOptions
  ...
  constructor(options: NasaClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw NasaError.fromError(error)
    }
  }
