 ...
 * Recruitee Client
 *
 * Auto-generated Integration client for Recruitee.
...
import { RecruiteeError } from './errors.js'
...
export class RecruiteeClient {
  private options: RecruiteeClientOptions
  ...
  constructor(options: RecruiteeClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw RecruiteeError.fromError(error)
    }
  }
