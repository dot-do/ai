 ...
 * Twelve data Client
 *
 * Auto-generated Integration client for Twelve data.
...
import { TwelveDataError } from './errors.js'
...
export class TwelveDataClient {
  private options: TwelveDataClientOptions
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw TwelveDataError.fromError(error)
    }
  }
