 ...
 * Synthflow ai Client
 *
 * Auto-generated Integration client for Synthflow ai.
...
import { SynthflowAiError } from './errors.js'
 ...
 */
export class SynthflowAiClient {
  private options: SynthflowAiClientOptions
  ...
  constructor(options: SynthflowAiClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw SynthflowAiError.fromError(error)
    }
  }
