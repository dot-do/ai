 ...
 * Shipengine Client
 *
 * Auto-generated Integration client for Shipengine.
...
import { ShipengineError } from './errors.js'

/**
 * Shipengine client options
 */
export interface ShipengineClientOptions {
...
export class ShipengineClient {
  private options: ShipengineClientOptions
  ...
  constructor(options: ShipengineClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw ShipengineError.fromError(error)
    }
  }
