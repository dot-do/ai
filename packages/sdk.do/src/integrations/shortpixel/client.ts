 ...
 * Shortpixel Client
 *
 * Auto-generated Integration client for Shortpixel.
...
import { ShortpixelError } from './errors.js'

/**
 * Shortpixel client options
 */
export interface ShortpixelClientOptions {
...
export class ShortpixelClient {
  private options: ShortpixelClientOptions
  ...
  constructor(options: ShortpixelClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw ShortpixelError.fromError(error)
    }
  }
