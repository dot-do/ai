/**
 * Anchor browser Client
 *
 * Auto-generated Integration client for Anchor browser.
...
import { AnchorBrowserError } from './errors.js'
...
export class AnchorBrowserClient {
  private options: AnchorBrowserClientOptions
  ...
  constructor(options: AnchorBrowserClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw AnchorBrowserError.fromError(error)
    }
  }
