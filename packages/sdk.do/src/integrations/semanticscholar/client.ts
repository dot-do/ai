 ...
 *
 * Auto-generated Integration client for Semanticscholar.
...
import { SemanticscholarError } from './errors.js'

/**
 * Semanticscholar client options
 */
...
export class SemanticscholarClient {
  private options: SemanticscholarClientOptions
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw SemanticscholarError.fromError(error)
    }
  }
