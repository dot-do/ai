 ...
 * Flutterwave Client
 *
 * Auto-generated Integration client for Flutterwave.
...
import { FlutterwaveError } from './errors.js'

/**
 * Flutterwave client options
 */
...
export class FlutterwaveClient {
  private options: FlutterwaveClientOptions
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw FlutterwaveError.fromError(error)
    }
  }
