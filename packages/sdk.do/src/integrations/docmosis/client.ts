 ...
 * Docmosis Client
 *
 * Auto-generated Integration client for Docmosis.
...
import { DocmosisError } from './errors.js'
 ...
 */
export class DocmosisClient {
  private options: DocmosisClientOptions
  ...
  constructor(options: DocmosisClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw DocmosisError.fromError(error)
    }
  }
