 ...
 * Mopinion Client
 *
 * Auto-generated Integration client for Mopinion.
...
import { MopinionError } from './errors.js'

/**
 * Mopinion client options
 */
export interface MopinionClientOptions {
...
export class MopinionClient {
  private options: MopinionClientOptions
  ...
  constructor(options: MopinionClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw MopinionError.fromError(error)
    }
  }
