 ...
 * Fireflies Client
 *
 * Auto-generated Integration client for Fireflies.
...
import { FirefliesError } from './errors.js'

/**
 * Fireflies client options
 */
...
export class FirefliesClient {
  private options: FirefliesClientOptions
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw FirefliesError.fromError(error)
    }
  }
