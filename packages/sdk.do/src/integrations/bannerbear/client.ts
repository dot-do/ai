 ...
 * Bannerbear Client
 *
 * Auto-generated Integration client for Bannerbear.
...
import { BannerbearError } from './errors.js'

/**
 * Bannerbear client options
 */
export interface BannerbearClientOptions {
...
export class BannerbearClient {
  private options: BannerbearClientOptions
  ...
  constructor(options: BannerbearClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw BannerbearError.fromError(error)
    }
  }
