 ...
 * Mailersend Client
 *
 * Auto-generated Integration client for Mailersend.
...
/**
 * Mailersend client options
 */
export interface MailersendClientOptions {
...
export class MailersendClient {
  private options: MailersendClientOptions
  ...
  constructor(options: MailersendClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw MailersendError.fromError(error)
    }
  }
