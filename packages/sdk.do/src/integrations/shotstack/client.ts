 ...
 * Shotstack Client
 *
 * Auto-generated Integration client for Shotstack.
...
import { ShotstackError } from './errors.js'
...
export class ShotstackClient {
  private options: ShotstackClientOptions
  ...
  constructor(options: ShotstackClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw ShotstackError.fromError(error)
    }
  }
