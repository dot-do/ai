 ...
 * Vero Client
 *
 * Auto-generated Integration client for Vero.
...
import { VeroError } from './errors.js'

/**
 * Vero client options
 */
export interface VeroClientOptions {
...
export class VeroClient {
  private options: VeroClientOptions
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw VeroError.fromError(error)
    }
  }
