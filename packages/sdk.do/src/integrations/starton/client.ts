 ...
 * Starton Client
 *
 * Auto-generated Integration client for Starton.
...
import { StartonError } from './errors.js'

/**
 * Starton client options
 */
export interface StartonClientOptions {
...
export class StartonClient {
  private options: StartonClientOptions
  ...
  constructor(options: StartonClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw StartonError.fromError(error)
    }
  }
