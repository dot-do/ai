 ...
 * Hackernews Client
 *
 * Auto-generated Integration client for Hackernews.
...
import { HackernewsError } from './errors.js'
...
export class HackernewsClient {
  private options: HackernewsClientOptions
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw HackernewsError.fromError(error)
    }
  }
