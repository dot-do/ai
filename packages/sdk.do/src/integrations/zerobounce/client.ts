 ...
 * Zerobounce Client
 *
 * Auto-generated Integration client for Zerobounce.
...
import { ZerobounceError } from './errors.js'

/**
 * Zerobounce client options
 */
...
export class ZerobounceClient {
  private options: ZerobounceClientOptions
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw ZerobounceError.fromError(error)
    }
  }
