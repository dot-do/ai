/**
 * Async interview Client
 *
 * Auto-generated Integration client for Async interview.
...
import { AsyncInterviewError } from './errors.js'
 ...
 */
export class AsyncInterviewClient {
  private options: AsyncInterviewClientOptions
  ...
  constructor(options: AsyncInterviewClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw AsyncInterviewError.fromError(error)
    }
  }
