 ...
 * Ascora Client
 *
 * Auto-generated Integration client for Ascora.
...
import { AscoraError } from './errors.js'

/**
 * Ascora client options
 */
export interface AscoraClientOptions {
...
export class AscoraClient {
  private options: AscoraClientOptions
  ...
  constructor(options: AscoraClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw AscoraError.fromError(error)
    }
  }
