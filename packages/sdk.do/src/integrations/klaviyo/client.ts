 ...
 * Klaviyo Client
 *
 * Auto-generated Integration client for Klaviyo.
...
import { KlaviyoError } from './errors.js'

/**
 * Klaviyo client options
 */
...
export class KlaviyoClient {
  private options: KlaviyoClientOptions
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw KlaviyoError.fromError(error)
    }
  }
