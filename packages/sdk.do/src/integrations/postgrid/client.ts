 ...
 * Postgrid Client
 *
 * Auto-generated Integration client for Postgrid.
...
import { PostgridError } from './errors.js'

/**
 * Postgrid client options
 */
export interface PostgridClientOptions {
...
export class PostgridClient {
  private options: PostgridClientOptions
  ...
  constructor(options: PostgridClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw PostgridError.fromError(error)
    }
  }
