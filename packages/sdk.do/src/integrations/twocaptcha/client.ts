 ...
 * Twocaptcha Client
 *
 * Auto-generated Integration client for Twocaptcha.
...
import { TwocaptchaError } from './errors.js'

/**
 * Twocaptcha client options
 */
...
export class TwocaptchaClient {
  private options: TwocaptchaClientOptions
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw TwocaptchaError.fromError(error)
    }
  }
