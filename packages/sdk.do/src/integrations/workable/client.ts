 ...
 * Workable Client
 *
 * Auto-generated Integration client for Workable.
...
import { WorkableError } from './errors.js'

/**
 * Workable client options
 */
export interface WorkableClientOptions {
...
export class WorkableClient {
  private options: WorkableClientOptions
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw WorkableError.fromError(error)
    }
  }
