 ...
 * Freshdesk Webhooks
 *
 * Auto-generated webhook handling for Freshdesk Integration.
...
export type WebhookEvent = TicketCreatedEvent | TicketUpdatedEvent
 ...
 */
export class FreshdeskWebhookHandler {
...
export class WebhookEventRouter {
  ...
  /**
   * Register handler for ticket_created events
   * @param handler - Event handler function
   */
  ...
  /**
   * Register handler for ticket_updated events
   * @param handler - Event handler function
   */
