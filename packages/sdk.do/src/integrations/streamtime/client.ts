 ...
 * Streamtime Client
 *
 * Auto-generated Integration client for Streamtime.
...
import { StreamtimeError } from './errors.js'
...
export class StreamtimeClient {
  private options: StreamtimeClientOptions
  ...
  constructor(options: StreamtimeClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw StreamtimeError.fromError(error)
    }
  }
