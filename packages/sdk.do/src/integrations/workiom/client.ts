 ...
 * Workiom Client
 *
 * Auto-generated Integration client for Workiom.
...
import { WorkiomError } from './errors.js'
 ...
 */
export class WorkiomClient {
  private options: WorkiomClientOptions
  ...
  constructor(options: WorkiomClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw WorkiomError.fromError(error)
    }
  }
