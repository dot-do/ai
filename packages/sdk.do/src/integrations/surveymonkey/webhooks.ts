 ...
 *
 * Auto-generated webhook handling for SurveyMonkey Integration.
...
export type WebhookEvent = ResponseCompletedEvent
...
/**
 * SurveyMonkey Webhook Handler
 *
 * Handles webhook signature verification and event parsing.
 */
export class SurveymonkeyWebhookHandler {
...
export class WebhookEventRouter {
  ...
  /**
   * Register handler for response_completed events
   * @param handler - Event handler function
   */
  onResponseCompleted(handler: (event: ResponseCompletedEvent) => Promise<void>): void {
    this.on(WEBHOOK_EVENTS.RESPONSE_COMPLETED, handler as any)
  }
