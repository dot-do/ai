 ...
 * Axonaut Client
 *
 * Auto-generated Integration client for Axonaut.
...
import { AxonautError } from './errors.js'
...
export class AxonautClient {
  private options: AxonautClientOptions
  ...
  constructor(options: AxonautClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw AxonautError.fromError(error)
    }
  }
