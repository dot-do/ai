 ...
 * Builtwith Client
 *
 * Auto-generated Integration client for Builtwith.
...
import { BuiltwithError } from './errors.js'

/**
 * Builtwith client options
 */
export interface BuiltwithClientOptions {
...
export class BuiltwithClient {
  private options: BuiltwithClientOptions
  ...
  constructor(options: BuiltwithClientOptions) {
    this.options = {
  ...
  private async actionExecute(params: ActionExecuteParams): Promise<object> {
    try {
      ...
      throw BuiltwithError.fromError(error)
    }
  }
