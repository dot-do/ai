 ...
 */
export function renderCursorRules(config: AgentConfig): string {
  const lines: string[] = []
 ...
 */
export function renderClaudeMd(config: AgentConfig): string {
  const sections: string[] = []
 ...
 */
export function renderWindsurf(config: AgentConfig): string {
 ...
 */
export function renderJson(config: AgentConfig, pretty = false): string {
 ...
 */
export function render(config: AgentConfig, options: RenderOptions): string {
