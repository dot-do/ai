 ...
 */
export function parseAgentsMd(content: string): AgentConfig {
 ...
 */
export function parseCursorRules(content: string): AgentConfig {
  const config: AgentConfig = {
    name: 'Cursor Agent',
    rules: [],
  }
 ...
 */
export function parseClaudeMd(content: string): AgentConfig {
  const config: AgentConfig = {
    name: 'Claude Agent',
 ...
 */
export function parseWindsurf(content: string): AgentConfig {
 ...
 * Parse JSON format
 */
export function parseJson(content: string): AgentConfig {
 ...
 */
export function parse(content: string, options: ParseOptions = {}): AgentConfig {
  if (options.format) {
...
function parseByFormat(content: string, format: string): AgentConfig {
  switch (format) {
    case 'agents':
      return parseAgentsMd(content)
    case 'cursor':
...
function saveSection(config: AgentConfig, section: string, content: string) {
